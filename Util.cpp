...
void menu(int &choice, std::vector<std::string> &menuHold, std::string option1, std::string option2, std::string option3, std::string option4, std::string option5)
{
	...
	case 0:
		...
		menuHold.push_back(option3);
		menuHold.push_back(option4);
		menuHold.push_back(option5);
